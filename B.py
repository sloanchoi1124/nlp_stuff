...
class BerkeleyAligner():
    ...
    def train(self, aligned_sents, num_iters):
        ...
        t = {}
        q = {}
        t = defaultdict(lambda: defaultdict(lambda: MIN_PROB))
        ...
        translation_table1 = defaultdict(lambda: defaultdict(lambda: MIN_PROB))

        alignment_table1 = defaultdict(lambda: defaultdict(lambda: defaultdict(lambda: defaultdict(lambda: MIN_PROB))))
